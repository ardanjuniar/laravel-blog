...
<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-fw fa-plus"></i> Create Artikel</h3>
    </div>
    <div class="box-body">
        <form action="{{ route('article.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group @error('categori') {{'has-error'}} @enderror">
                ...
                <select class="form-control" name="categori" id="categori">
                    ...
                    <option value="{{ $categori->id }}" {{ old('categori') == $categori->id ? 'selected' : '' }}>
            ...
            <button type="submit" class="btn btn-primary btn-flat btn-block"><i class="fa fa-fw fa-plus"></i> Tambah
                Artikel</button>
        </form>
    </div>
</div>
